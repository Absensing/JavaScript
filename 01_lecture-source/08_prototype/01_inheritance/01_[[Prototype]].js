...
/*
    ...
    object에서 프로퍼티를 읽으려고 할 때, 해당 프로퍼티가 없으면 자바 스크립트는
...
/*
    ...
    함수 Object.getprototypeOf나 Object.setPrototypeOf 를 써서
    프로토 타입을 설정하는 것이 좋다.
*/
...
// student 의 프로토타입은 user 이다. 혹은 student 는 user 를 상속 받는다 라고 표현한다.
// 프로토타입에서 상속받은 프로퍼티 '상속 프로퍼티(inherited property)'라고 부른다.

const ohhgiraffersStudent = {
    class : 402,
    __proto__ : student
};
...
console.log(ohhgiraffersStudent.activate);  // user 에서 상속
console.log(ohhgiraffersStudent.passion);   // student 에서 상속
